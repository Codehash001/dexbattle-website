...
function Nfts () {
    ...
    <div className='flex flex-col my-10 mx-16 justify-between items-center'>
       <div className='mt-10'>
        <h1 data-aos="flip-right" className='text-3xl bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 bg-clip-text text-transparent  font-Kanit text-center uppercase font-semibold tracking-wide'>The Problem</h1>
...
in-game things, yet they cannot sell them. This represents a return on investment.
            ...
            <h1 data-aos="flip-right" className='text-3xl bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 bg-clip-text text-transparent  font-Kanit text-center uppercase mt-10 font-semibold tracking-wide'>Our Solution</h1>
        <p  data-aos="flip-right" className='text-center font-Kanit text-[20px] text-gray-400 mt-4 mb-5'>
...
<div className='mt-10'>
        <h1 data-aos="flip-right" className='text-3xl bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 bg-clip-text text-transparent font-Kanit text-center uppercase font-semibold tracking-wide'>NFT Characters</h1>
...
guilds systems.
            ...
            <h1 data-aos="flip-right" className='text-3xl bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 bg-clip-text text-transparent font-Kanit text-center uppercase mt-10 font-semibold tracking-wide'>NFT marketplace</h1>
        <p data-aos="flip-right" className='text-center font-Kanit text-[20px] text-gray-400 mt-4'>
    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="mt-8 lg:-mx-6 lg:flex lg:items-center">
            ...
            <div class="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
                <p class="text-[28px] tracking-wide text-blue-500 uppercase mb-8 font-Kanit font-semibold">Dex Battle Characters and Weapons are available to buy as fungable tokens on Opeansea</p>
