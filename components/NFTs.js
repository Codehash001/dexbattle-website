...
function Nfts () {
    ...
    <div className='flex flex-col my-10 mx-16 justify-between items-center'>
       <div className='mt-10'>
        ...
        <p data-aos="flip-right" className='text-justify font-Kanit text-[20px] text-gray-400 mt-4 mb-5'>
...
<div className='mt-10'>
        ...
        <p data-aos="flip-right" className='text-justify font-Kanit text-[20px] text-gray-400 mt-4'>
