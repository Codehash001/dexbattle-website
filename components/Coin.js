...
function Coins () {
    ...
    return (
     ...
     <div className='flex flex-row md:mx-16 mx-2 justify-between items-center'>
          <div className='md:flex flex-col my-4 w-[70%] mr-10'>
...
overall brand of Dex coin.
        ...
        <div className='md:flex flex-row mx-16 my-[50px] justify-evenly'>
