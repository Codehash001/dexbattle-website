    ...
    return(
        ...
        <div className="w-screen flex flex-col items-center overflow-hidden">
            ...
            <p className="text-white text-[18px]">
                ...
                <br/>
                <br/>
                Welcome to Dex Battle Gaming website ,<a hfref='/'> www.dexbattle.com</a>These Dex Battle Terms of Use (the “Terms”)
                set forth the terms and conditions under which DB Gaming Ltd, a company incorporated in Turkey and Asia, and its subsidiaries
                and affiliates (collectively, “DB”, “us”, “our”, or “we”), and you (“you” or “your”) agree to be governed as it relates to
                any of your activity in The Dex Battle, a decentralized, community-driven platform created and owned by DB (“Dex Battle”).
                These Terms govern your access to, use of, and interaction with The Dex Battle, including any content, functionality,
                and services offered on or through The Dex Battle and your creation of any Assets and/or Games (defined below) (collectively, the “Services”).
                <br/>
                <br/>
                ...
                <span className="font-semibold">Dex Battle </span>
                <br/>
                <br/>
                Dex Battle enables users such as you to create, buy, transfer, and trade unique digital game assets in voxel art (each,
                an “Asset” and together, the “Assets”), which can then be used on Dex Battle for game-making purposes. Dex Battle further
                enables users such as you to purchase and publish onto LANDs parcels in Dex Battle within which you can create Assets and
                visual scripting using Dex Battle Game Maker, which creates an interactive experience built for, and published on, Dex Battle
                (each, a “Game”). A Game may be made available to users of Dex Battle and you will control the pricing and business model (free, free-2-play or premium) of the Game.
                <br/>
                <br/>

                <span className="font-semibold">ASSET & GAME CREATION</span>
                <br/>
                <br/>
...
<li>Assets are created in VoxEdit. Games are created with Dex Battle Game Maker.</li>
<li>Assets and Games must not be pornographic, threatening, harassing, libelous, hate-oriented, harmful, defamatory, racist, xenophobic, or illegal, as will be determined by DB in its sole discretion.</li>
<li>To reiterate, each new Asset must be different enough from all existing Assets. If variations are not allowed, which is the default, no Asset should look like, or be similar to, another Asset even if they differ in size and/or color. New Assets being sufficiently different from existing Assets will be determined in the sole discretion of DB. </li>
<li>By uploading an Asset to Dex Battle, you agree never to publish the Asset elsewhere.</li>
<li>You are solely responsible for ensuring that any Assets you submit to the Services comply with any applicable laws and third-party rights, including but not limited to any intellectual property rights, privacy rights and publicity rights.</li>
<li>Dex Battle always has the right, in its sole discretion, to accept or reject any Assets and/or Games</li>
                </ul>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="font-semibold">SALE OF ASSETS AND GAMES; PAYMENT</span>
                <br/>
                <br/>
                You may make your Asset eligible to be sold in Dex Battle marketplace. You and DB shall mutually agree on the price for the Asset in The Sandbox marketplace.
                You will control the scarcity of the Asset in The Dex Battle marketplace. Any revenue earned in Dex Battle marketplace for sales of the Asset, minus any transaction fees,
                shall be paid to you immediately on the blockchain by the purchaser of your Asset. A Game may be made available for sale to users of Dex Battle and you will control
                the pricing and business model (free, free-2-play or premium) of the Game. Any revenue earned in Dex Battle marketplace for sales of a Game, minus any transaction fees,
                shall be paid to you immediately on the blockchain by the purchaser of your Game.
                <br/>
                <br/>
                <span className="font-semibold">OWNERSHIP OF DB CONTENT</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="font-semibold">OWNERSHIP OF ASSETS AND GAMES</span>
                <br/>
                <br/>
                ...
                <span className="font-semibold">REPRESENTATIONS AND WARRANTIES</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="font-semibold">RIGHT TO MONITOR, MODERATE, OR REMOVE</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="font-semibold">RESTRICTIONS AND OBLIGATIONS</span>
                <br/>
                <br/>
                ...
                <br/>
                <ul className="list-disc">
                    <li>Transmit or otherwise make available any unsolicited or unauthorized advertising, promotional materials, “junk mail,” “spam,” “chain letters,” “pyramid schemes,” or any other form of solicitation;</li>
                    <li>Transmit material or content that promotes, provides, or relates to instructional information about illegal activities or promotes physical harm or injury against any individual or group;</li>
                    <li>Transmit or encourage the transmission of any material that may infringe the intellectual property rights or other rights of third parties, including trademark, copyright, patent, or right of publicity, or which otherwise constitutes or promotes counterfeit materials or goods;</li>
                    <li>Use the services in a manner that (a) is likely to interrupt, suspend, slow down or hinder the continuity of the Services, (b) constitutes an intrusion or attempt to break into the Services or DB’s computer or networking systems, (c) will divert of the Services’ system resources, (d) may place a disproportionate load on the infrastructure of the Services, and (e) constitutes an attack on security and authentication measures of the Services or DB&apos;s computer or networking systems;</li>
                </ul>
                ...
                <br/>
                <br/>
                <span className="font-semibold">MODIFYING AND TERMINATING THE SERVICE</span>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                <span className="font-semibold">OTHER WEBSITES AND SERVICES</span>
                <br/>
                <br/>
